          ...
          <div class="AllDetails">
            ...
            <div class="Details">
              ...
              <div class="ProcessDetails">
                ...
                <ul>
                  <li>
                    פתיחת תיק מועמדת עד לתאריך ה-30.06.2021 על ידי פנייה בכתב
                    מאת עו"ס מטפל. מילוי כל הטפסים הנדרשים (מצ"ב בהמשך).
                  </li>
                  <li>
                    ראיון אישי - לאחר אישור הועדה מטעם העמותה, תזומן הצעירה
                    בליווי עו"ס מפנה לראיון במשרדי העמותה.{" "}
                  </li>
                  <li>
                    אינטייק - במידה והצעירה עברה את שלב הריאיון , תופנה אל
                    פסיכולוגית העמותה להערכה אישית.
                    <br /> החלטה לגבי קבלת הצעירה לדירה, תינתן לעו"ס המפנה
                    (במייל) שבועיים מסיום התהליך.
                  </li>
                  <li>
  ...
  return (
    <div class="allThePage">
      ...
      <div class="SubmitRequest">
        <div class="title1">
          <h2>הגשת בקשה לפרויקט דירת בוגרות</h2>
        </div>
        <br />
        <hr />
        <br />
